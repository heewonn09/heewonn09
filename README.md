...
백엔드 개발과 데이터 처리, 그리고 AI + IoT 시스템에 관심이 있는 개발자입니다.

Spring Boot 기반 REST API 개발 및  
IoT 디바이스 연동 및 시스템 구축 프로젝트를 경험했습니다.

반복적인 테스트와 문제 해결 과정을 통해  
**안정적인 시스템을 만드는 개발 과정**을 추구합니다.
...
- 💻 **Backend Developer**
- ⚙️ Spring Boot 기반 **REST API 설계 및 구현**
- 🗄️ 데이터 설계 및 **DB 최적화에 관심**
- 🧠 **RAG 기반 AI 챗봇 시스템 구축 경험**
- 📡 **IoT 디바이스(MQTT) 연동 스마트홈 프로젝트 개발**
- 📱 React / React Native 기반 서비스 구현 경험

- [포트폴리오](https://www.notion.so/1eced7ed6e4480a9baa4e06a471d7763?source=copy_link)
...
![Pinecone](https://img.shields.io/badge/Pinecone-3C3C3C?style=for-the-badge)
...
![Text Embedding](https://img.shields.io/badge/Text_Embedding-7B61FF?style=for-the-badge)
